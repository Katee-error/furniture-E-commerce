      ...
      <Container maxW="container.lg">
        <Grid templateColumns='repeat(4, 1fr)' gap={7} alignItems={'start'}>
          <GridItem>
            ...
            <Text fontSize={'12px'} color={'gray.500'}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam eaque dolore repudiandae explicabo non officiis assumenda nobis voluptatum hic voluptate.</Text>
          </GridItem>
          <GridItem>
